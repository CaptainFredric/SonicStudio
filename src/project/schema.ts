...
export const TRACK_VOICE_PRESET_DEFINITIONS: TrackVoicePresetDefinition[] = [
  ...
  {
    description: 'Soft sine body with a quick hammer attack and a long decay to a low sustain. The mellow, intimate piano for ballads and quiet keys.',
    focus: 'Felt piano',
    id: 'felt-piano',
    params: { attack: 0.006, chorusSend: 0.1, cutoff: 2400, decay: 0.9, release: 0.85, resonance: 1, reverbSend: 0.26, sustain: 0.2 },
    label: 'Felt Piano',
    source: { detune: 0, octaveShift: 0, portamento: 0, waveform: 'sine' },
    trackTypes: ['piano', 'bell', 'pluck'],
  },
  {
    description: 'Brighter triangle tone with more top end and a faster decay. An upright with bite, made for comping chords and rhythmic figures.',
    focus: 'Bright upright',
    id: 'bright-upright',
    params: { attack: 0.004, cutoff: 3600, decay: 0.7, release: 0.6, resonance: 1.1, reverbSend: 0.2, sustain: 0.16 },
    label: 'Bright Upright',
    source: { detune: 3, octaveShift: 0, portamento: 0, waveform: 'triangle' },
    trackTypes: ['piano', 'pluck', 'lead'],
  },
  {
    description: 'A chorused electric-piano voice with a slow tremolo and a touch of delay. Warm and round, sits well under vocals or a lead.',
    focus: 'Electric keys',
    id: 'electric-keys',
    params: { attack: 0.008, chorusSend: 0.4, cutoff: 2200, decay: 0.6, delaySend: 0.16, release: 0.9, resonance: 1, reverbSend: 0.3, sustain: 0.34, vibratoDepth: 0.08, vibratoRate: 5.2 },
    label: 'Electric Keys',
    source: { detune: 6, octaveShift: 0, portamento: 0, waveform: 'triangle' },
    trackTypes: ['piano', 'pad', 'lead'],
  },
  {
