...
// the Alt+1..4 shortcuts both read this so the numbering always matches what
// is on screen.
export const APP_VIEW_ORDER: readonly AppView[] = ['SEQUENCER', 'PIANO_ROLL', 'MIXER', 'ARRANGER'];
