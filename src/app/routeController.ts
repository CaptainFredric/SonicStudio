...
export const TEMPLATE_ALIASES: Record<string, SessionTemplateId> = {
  ...
  crystal: 'crystal-garden',
  'crystal-garden': 'crystal-garden',
  late: 'late-hours',
  'late-hours': 'late-hours',
  midnight: 'midnight-trap',
  'midnight-trap': 'midnight-trap',
  trap: 'midnight-trap',
  neon: 'neon-breaks',
  'neon-breaks': 'neon-breaks',
  palm: 'palm-hour',
  'palm-hour': 'palm-hour',
  garage: 'pirate-radio',
  pirate: 'pirate-radio',
  'pirate-radio': 'pirate-radio',
  disco: 'saturday-lights',
  saturday: 'saturday-lights',
  'saturday-lights': 'saturday-lights',
  funk: 'brass-district',
  brass: 'brass-district',
  'brass-district': 'brass-district',
  pulse: 'pulse-rider',
  'pulse-rider': 'pulse-rider',
  sunset: 'sunset-house',
  'sunset-house': 'sunset-house',
  twilight: 'twilight-frame',
  'twilight-frame': 'twilight-frame',
  velvet: 'velvet-suite',
  'velvet-suite': 'velvet-suite',
  'lo-fi': 'lofi-sunday',
  lofi: 'lofi-sunday',
